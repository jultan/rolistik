...
*/
		...
		actionAfficherNumerosPnj     = menuAffichage->addAction(tr("Afficher numéros PNJ"));
/*
		...
		actionCarre                  = sousMenuGrille->addAction(tr("Carrés"));
...
*/
	...
	{
		// Ouverture, sauvegarde, fermeture des plans
		...
		QObject::connect(actionAideLogiciel, SIGNAL(triggered(bool)), this, SLOT(aideEnLigne()));
	}
	...
	void MainWindow::ajouterCarte(CarteFenetre *carteFenetre, QString titre)
	{
		...
		switch(G_outilCourant)
		{
			...
			case BarreOutils::etatPerso :
				...
				break;
			default :
				qWarning("Outil non défini a la creation d'une fenêtre (ajouterCarte - MainWindow.cpp)");
				break;
		}
	...
	{
		// Ouverture du selecteur de fichier
		QString fichier = QFileDialog::getOpenFileName(this, tr("Ouvrir scénario"), G_dossierScenarii, tr("Scénarii (*.sce)"));
	...
	{
		// Ouverture du selecteur de fichiers
		QString fichier = QFileDialog::getSaveFileName(this, tr("Sauvegarder scénario"), G_dossierScenarii, tr("Scénarii (*.sce)"));
